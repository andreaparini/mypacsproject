...
Mesh::Mesh(const double L1, const double L2, const double H1, const double H2,
           const double W1, const double W2, const int Nx_,
           const int Ny_, const int Nz_, const int region_,
           vector<int> sides_):
        L (L2 - L1),
        H (H2 - H1),
        W (W2 - W1),
...
vector<int> Mesh::sort_indexes(const vector<int>& v){
